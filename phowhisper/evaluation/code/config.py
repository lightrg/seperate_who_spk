...
HARD_MAX_SEC = 30.0
MERGE_GAP_SEC = 0.50          # max gap to merge 2 segments of DIFFERENT speakers
MERGE_GAP_SAME_SPK_SEC = 1.50 # max gap to merge 2 segments of the SAME speaker (conditional)
PAD_LEFT_SEC = 0.10
PAD_RIGHT_SEC = 0.20
